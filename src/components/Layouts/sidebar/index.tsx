...
export function Sidebar() {
  ...
  // 1. Filter Data Navigasi Berdasarkan Role
  ...
  // 2. Auto-expand dropdown jika sub-menu aktif saat page load/refresh
  useEffect(() => {
  ...
  // Handler untuk menutup sidebar di mobile setelah klik
  ...
  return (
    <>
      ...
      <aside
        ...
        aria-hidden={!isOpen}
        // FIX: inert menggunakan boolean murni
