...
import FormTambahKategori from "./FormTambahKategori"; // Kita buat komponen kecil di bawah
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {/* Kolom Kiri: Form Tambah (1 per 3 bagian layar) */}
        <div className="md:col-span-1">
          <FormTambahKategori />
        </div>

        {/* Kolom Kanan: Tabel Kategori (2 per 3 bagian layar) */}
        <div className="dark:border-strokedark dark:bg-boxdark rounded-xl border border-gray-200 bg-white shadow-sm md:col-span-2">
          <div className="dark:border-strokedark border-b border-gray-100 px-6 py-4">
            <h3 className="flex items-center gap-2 font-semibold text-gray-900 dark:text-white">
              <Tag className="h-4 w-4 text-primary" /> Daftar Kategori
            </h3>
          </div>
